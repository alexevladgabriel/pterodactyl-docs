...
{/* Sorry, but this file is off limits to additions or deletions that are not the result of fixing grammar or spelling mistakes. */}
...
<Callout type="info">
  Assume someone is acting in good faith when responding to them. You don't have
  to agree with everyone, and you don't need to respond to everything.
</Callout>
...
<Callout type="warning">
  Advertising commercial services within your username or display name on
  Discord is forbidden.
</Callout>
