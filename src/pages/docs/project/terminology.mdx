...
![](../../../../public/imgs/simple_setup_diagram.png)

## Advanced Setup Diagram

<Callout type="info">
  Panel and Wings on the same machine. It is also possible to install wings on
  the panel machine so it acts as panel and node machine at once.
</Callout>

![](../../../../public/imgs/example_setup.png)
