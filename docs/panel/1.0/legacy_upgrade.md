...
prev: false
next:
  text: 'Migrating to Wings'
  link: '/wings/1.0/migrating'
---

# Legacy Upgrades
This upgrade guide is for **upgrading from 0.7.X to 1.11.x**. If you are trying to do an upgrade on a 1.X Panel
please [use this guide instead](/panel/1.0/updating). During this upgrade process you will have some periods
