...
next:
  ...
  link: '/panel/1.0/getting_started#download-files'
---

# CentOS 8, Rocky Linux 8, AlmaLinux 8, Fedora Server 38
In this guide we will install Pterodactyl v1.X &mdash; including all of it's dependencies &mdash; and configure our webserver to serve it using SSL.

[[toc]]

::: tip
This guide is based off the [official installation documentation](/panel/1.0/getting_started) but is tailored specifically for Enterprise Linux 8.
:::

## Install Requirements and Additional Utilities
We will install all of Pterodactyl's [required](/panel/1.0/getting_started#dependencies) dependencies and a few aditional utilities.
...
#### Adding MariaDB user
To add your first user to the database, see our tutorial on [setting up MySQL](/tutorials/mysql_setup).
...
<<< @/.snippets/php-fpm/pterodactyl-centos.conf{properties}
...
### Nginx
Please check our [tutorial](/tutorials/creating_ssl_certificates) on generating SSL certificates for more information.

#### SSL Configuration
<<< @/.snippets/webservers/nginx/centos.conf{5,11,26-27 nginx}
