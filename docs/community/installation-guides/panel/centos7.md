...
# CentOS 7
In this guide we will install Pterodactyl v1.X &mdash; including all of it's dependencies &mdash; and configure our webserver
to serve it using SSL.

[[toc]]

::: tip
This guide is based off the [official installation documentation](/panel/1.0/getting_started) but is tailored specifically for CentOS 7.
:::
...
<<< @/.snippets/php-fpm/pterodactyl-centos.conf{yml}
