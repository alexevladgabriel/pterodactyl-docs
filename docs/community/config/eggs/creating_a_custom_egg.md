...
![](/community/config/eggs/Pterodactyl_Create_New_Egg_Select.png)
...
![](/community/config/eggs/Pterodactyl_Create_New_Egg_Process_Management.png)
...
our [Creating a Docker Image](/community/config/eggs/creating_a_custom_image) guide.
...
- `file` &mdash; This parser goes based on matching the beginning of lines, and not a specific property like the other five.
...
![](/community/config/eggs/Pterodactyl_Create_New_Egg_Copy_Settings_From.png)
...
![](/community/config/eggs/Pterodactyl_Create_New_Egg_Variables.png)
...
- `Users Can View` &mdash; allows a user to view the field on the front-end, as well as the assigned value of that variable.
They will be able to see it replaced in their startup command.
- `Users Can Edit` &mdash; allows a user to edit the value of the variable, for example the name of their `server.jar` file
...
![](/community/config/eggs/Pterodactyl_Create_New_Egg_Startup.png)
